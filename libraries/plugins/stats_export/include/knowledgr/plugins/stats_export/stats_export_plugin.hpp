...
#define KNOWLEDGR_STATS_EXPORT_PLUGIN_NAME "stats_export"
...
class stats_export_plugin : public appbase::plugin< stats_export_plugin >
{
   public:
      ...
      APPBASE_PLUGIN_REQUIRES(
         (knowledgr::plugins::block_data_export::block_data_export_plugin)
         (knowledgr::plugins::chain::chain_plugin)
      )

      static const std::string& name() { static std::string name = KNOWLEDGR_STATS_EXPORT_PLUGIN_NAME; return name; }
