...
#define KNOWLEDGR_TAGS_API_PLUGIN_NAME "tags_api"
...
public:
   APPBASE_PLUGIN_REQUIRES(
      (knowledgr::plugins::tags::tags_plugin)
   ...
   static const std::string& name() { static std::string name = KNOWLEDGR_TAGS_API_PLUGIN_NAME; return name; }
