...
struct private_message_operation : public colab::protocol::base_operation
{
...
FC_REFLECT( colab::private_message::private_message_operation, (from)(to)(from_memo_key)(to_memo_key)(sent_time)(checksum)(encrypted_message) )

COLAB_DECLARE_OPERATION_TYPE( colab::private_message::private_message_plugin_operation )
FC_REFLECT_TYPENAME( colab::private_message::private_message_plugin_operation )
