...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( knowledgr::app::application& app )
            :_app( app ) {}
         ...
         knowledgr::app::application& _app;
   };
   ...
   statistics blockchain_statistics_api_impl::get_stats_for_interval( fc::time_point_sec start, fc::time_point_sec end )const
   {
      ...
      const auto& sizes = _app.get_plugin< blockchain_statistics_plugin >( KNOWLEDGR_BLOCKCHAIN_STATISTICS_PLUGIN_NAME )->get_tracked_buckets();
...
blockchain_statistics_api::blockchain_statistics_api( const knowledgr::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->knlg_transferred                      += b.knlg_transferred;
...
//   this->transfers_to_vesting                   += b.transfers_to_vesting;
   this->knlg_vested                           += b.knlg_vested;
...
//    this->sbd_conversion_requests_filled         += b.sbd_conversion_requests_filled;
   this->knlg_converted                        += b.knlg_converted;
