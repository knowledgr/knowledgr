...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_nlg_value = 0;     ///< KNLG Value of author rewards
   ...
   share_type           curation_rewards_nlg_value = 0;         ///< KNLG Value of curation rewards
   ...
   share_type           nlg_sent = 0;                           ///< KNLG sent from this account
   share_type           nlg_received = 0;                       ///< KNLG received by this account
   ...
   share_type           nlg_vested = 0;                         ///< KNLG vested by the account
   ...
   share_type           nlg_received_from_withdrawls = 0;       ///< KNLG received from this account's vesting withdrawals
   share_type           nlg_received_from_routes = 0;           ///< KNLG received from another account's vesting withdrawals
   ...
   share_type           limit_order_nlg_paid = 0;               ///< KNLG paid by limit orders
   share_type           limit_order_nlg_received = 0;           ///< KNLG received from limit orders
...
FC_REFLECT( knowledgr::account_statistics::account_stats_bucket_object,
   ...
   (vests_withdrawn)
   (nlg_received_from_withdrawls)
   (nlg_received_from_routes)
   ...
   (limit_order_nlg_paid)
   (limit_order_nlg_received)
