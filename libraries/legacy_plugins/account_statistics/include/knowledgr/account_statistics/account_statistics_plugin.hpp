...
struct account_stats_bucket_object : public object< account_stats_bucket_object_type, account_stats_bucket_object >
{
   ...
   share_type           author_rewards_total_nlg_value = 0;     ///< NLG Value of author rewards
   ...
   share_type           curation_rewards_nlg_value = 0;         ///< NLG Value of curation rewards
   ...
   share_type           liquidity_rewards = 0;                    ///< Amount of NLG paid as liquidity rewards
   ...
   share_type           nlg_sent = 0;                           ///< NLG sent from this account
   share_type           nlg_received = 0;                       ///< NLG received by this account
   ...
   share_type           nlg_vested = 0;                         ///< NLG vested by the account
   ...
   share_type           nlg_received_from_withdrawls = 0;       ///< NLG received from this account's vesting withdrawals
   share_type           nlg_received_from_routes = 0;           ///< NLG received from another account's vesting withdrawals
   ...
   share_type           limit_order_nlg_paid = 0;               ///< NLG paid by limit orders
   share_type           limit_order_nlg_received = 0;           ///< NLG received from limit orders
