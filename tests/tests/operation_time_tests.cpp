...
BOOST_AUTO_TEST_CASE( comment_payout_equalize )
{
   try
   {
      ...
      // set a ridiculously high KNLG price ($1 / satoshi) to disable dust threshold
...
BOOST_AUTO_TEST_CASE( comment_payout_dust )
{
   try
   {
      ...
      // If comments are paid out independent of order, then the last satoshi of KNLG cannot be divided among them
      const auto rf = db->get< reward_fund_object, by_name >( KNOWLEDGR_POST_REWARD_FUND_NAME );
...
/*BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto bob_comment_payout = asset( ( ( uint128_t( bob_comment_rshares.value ) * bob_comment_rshares.value * reward_knowledgr.amount.value ) / total_rshares2 ).to_uint64(), KNLG_SYMBOL );
      auto bob_comment_discussion_rewards = asset( bob_comment_payout.amount / 4, KNLG_SYMBOL );
      bob_comment_payout -= bob_comment_discussion_rewards;
      auto bob_comment_sbd_reward = db->to_sbd( asset( bob_comment_payout.amount / 2, KNLG_SYMBOL ) );
      auto bob_comment_vesting_reward = ( bob_comment_payout - asset( bob_comment_payout.amount / 2, KNLG_SYMBOL) ) * db->get_dynamic_global_properties().get_vesting_share_price();
...
BOOST_AUTO_TEST_CASE( comment_payout )
{
   try
   {
      ...
      auto bob_comment_payout = asset( ( ( uint128_t( bob_comment_rshares.value ) * bob_comment_rshares.value * reward_knowledgr.amount.value ) / total_rshares2 ).to_uint64(), KNLG_SYMBOL );
      auto bob_comment_vote_rewards = asset( bob_comment_payout.amount / 2, KNLG_SYMBOL );
      bob_comment_payout -= bob_comment_vote_rewards;
      auto bob_comment_sbd_reward = asset( bob_comment_payout.amount / 2, KNLG_SYMBOL ) * exchange_rate;
      auto bob_comment_vesting_reward = ( bob_comment_payout - asset( bob_comment_payout.amount / 2, KNLG_SYMBOL ) ) * db->get_dynamic_global_properties().get_vesting_share_price();
      auto unclaimed_payments = bob_comment_vote_rewards;
      auto alice_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "alice" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), KNLG_SYMBOL );
      auto alice_vote_vesting = alice_vote_reward * db->get_dynamic_global_properties().get_vesting_share_price();
      auto bob_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "bob" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), KNLG_SYMBOL );
      auto bob_vote_vesting = bob_vote_reward * db->get_dynamic_global_properties().get_vesting_share_price();
      auto sam_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "sam" ) ).id ) )->weight ) * bob_comment_vote_rewards.amount.value ) / bob_comment_vote_total ), KNLG_SYMBOL );
      ...
      auto alice_comment_payout = asset( static_cast< uint64_t >( ( rf * rs2 ) / trs2 ), KNLG_SYMBOL );
      auto alice_comment_vote_rewards = asset( alice_comment_payout.amount / 2, KNLG_SYMBOL );
      alice_comment_payout -= alice_comment_vote_rewards;
      auto alice_comment_sbd_reward = asset( alice_comment_payout.amount / 2, KNLG_SYMBOL ) * exchange_rate;
      auto alice_comment_vesting_reward = ( alice_comment_payout - asset( alice_comment_payout.amount / 2, KNLG_SYMBOL ) ) * db->get_dynamic_global_properties().get_vesting_share_price();
      unclaimed_payments = alice_comment_vote_rewards;
      alice_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "alice" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), KNLG_SYMBOL );
      alice_vote_vesting = alice_vote_reward * db->get_dynamic_global_properties().get_vesting_share_price();
      bob_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "bob" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), KNLG_SYMBOL );
      bob_vote_vesting = bob_vote_reward * db->get_dynamic_global_properties().get_vesting_share_price();
      sam_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "sam" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), KNLG_SYMBOL );
      sam_vote_vesting = sam_vote_reward * db->get_dynamic_global_properties().get_vesting_share_price();
      auto dave_vote_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "dave" ) ).id ) )->weight ) * alice_comment_vote_rewards.amount.value ) / alice_comment_vote_total ), KNLG_SYMBOL );
...
BOOST_AUTO_TEST_CASE( nested_comments )
{
   try
   {
      ...
      auto alice_vote_alice_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "alice" ) ).id ) )->weight ) * alice_comment_vote_rewards ) / alice_comment.total_vote_weight ), KNLG_SYMBOL );
      auto bob_vote_alice_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "alice", string( "test" ).id, db->get_account( "bob" ) ).id ) )->weight ) * alice_comment_vote_rewards ) / alice_comment.total_vote_weight ), KNLG_SYMBOL );
      ...
      auto alice_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "alice" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), KNLG_SYMBOL );
      auto bob_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "bob" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), KNLG_SYMBOL );
      auto sam_vote_bob_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "bob", string( "test" ).id, db->get_account( "sam" ) ).id ) )->weight ) * bob_comment_vote_rewards ) / bob_comment.total_vote_weight ), KNLG_SYMBOL );
      ...
      auto bob_vote_dave_reward = asset( static_cast< uint64_t >( ( u256( vote_idx.find( std::make_tuple( db->get_comment( "dave", string( "test" ).id, db->get_account( "bob" ) ).id ) )->weight ) * dave_comment_vote_rewards ) / dave_comment.total_vote_weight ), KNLG_SYMBOL );
      ...
      auto alice_comment_total_payout = db->to_sbd( asset( alice_pays_alice_sbd + alice_pays_alice_vest, KNLG_SYMBOL ) );
      alice_comment_total_payout += db->to_sbd( asset( bob_pays_alice_sbd + bob_pays_alice_vest, KNLG_SYMBOL ) );
      alice_comment_total_payout += db->to_sbd( asset( dave_pays_alice_sbd + dave_pays_alice_vest, KNLG_SYMBOL ) );
      auto bob_comment_total_payout = db->to_sbd( asset( bob_pays_bob_sbd + bob_pays_bob_vest, KNLG_SYMBOL ) );
      bob_comment_total_payout += db->to_sbd( asset( dave_pays_bob_sbd + dave_pays_bob_vest, KNLG_SYMBOL ) );
      auto sam_comment_total_payout = db->to_sbd( asset( dave_pays_sam_sbd + dave_pays_sam_vest, KNLG_SYMBOL ) );
      auto dave_comment_total_payout = db->to_sbd( asset( dave_pays_dave_sbd + dave_pays_dave_vest, KNLG_SYMBOL ) );
      ...
      auto alice_total_sbd = alice_starting_sbd + asset( alice_pays_alice_sbd + bob_pays_alice_sbd + dave_pays_alice_sbd, KNLG_SYMBOL ) * exchange_rate;
      auto alice_total_vesting = alice_starting_vesting + asset( alice_pays_alice_vest + bob_pays_alice_vest + dave_pays_alice_vest + alice_vote_alice_reward.amount + alice_vote_bob_reward.amount, KNLG_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto bob_total_sbd = bob_starting_sbd + asset( bob_pays_bob_sbd + dave_pays_bob_sbd, KNLG_SYMBOL ) * exchange_rate;
      auto bob_total_vesting = bob_starting_vesting + asset( bob_pays_bob_vest + dave_pays_bob_vest + bob_vote_alice_reward.amount + bob_vote_bob_reward.amount + bob_vote_dave_reward.amount, KNLG_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto sam_total_sbd = sam_starting_sbd + asset( dave_pays_sam_sbd, KNLG_SYMBOL ) * exchange_rate;
      auto sam_total_vesting = bob_starting_vesting + asset( dave_pays_sam_vest + sam_vote_bob_reward.amount, KNLG_SYMBOL ) * gpo.get_vesting_share_price();
      ...
      auto dave_total_sbd = dave_starting_sbd + asset( dave_pays_dave_sbd, KNLG_SYMBOL ) * exchange_rate;
      auto dave_total_vesting = dave_starting_vesting + asset( dave_pays_dave_vest, KNLG_SYMBOL ) * gpo.get_vesting_share_price();
...
//       for( int i = 0; i < 7; i++ )
//       {
//          transfer( KNOWLEDGR_INIT_MINER_NAME, accounts[i], asset( 10000, KNLG_SYMBOL ) );
...
//       }
// 
//       ops[0].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset( 100000, KNLG_SYMBOL ) );
//       ops[1].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset( 105000, KNLG_SYMBOL ) );
//       ops[2].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset(  98000, KNLG_SYMBOL ) );
//       ops[3].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset(  97000, KNLG_SYMBOL ) );
//       ops[4].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset(  99000, KNLG_SYMBOL ) );
//       ops[5].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset(  97500, KNLG_SYMBOL ) );
//       ops[6].exchange_rate = price( asset( 1000, SBD_SYMBOL ), asset( 102000, KNLG_SYMBOL ) );
// 
//       for( int i = 0; i < 7; i++ )
//       {
...
//       BOOST_REQUIRE( feed_history.current_median_history == price( asset( 1000, SBD_SYMBOL ), asset( 99000, KNLG_SYMBOL) ) );
//       BOOST_REQUIRE( feed_history.price_history[ 0 ] == price( asset( 1000, SBD_SYMBOL ), asset( 99000, KNLG_SYMBOL) ) );
//       validate_database();
// 
//       for ( int i = 0; i < 23; i++ )
//       {
...
//             ops[j].exchange_rate = price( ops[j].exchange_rate.base, asset( ops[j].exchange_rate.quote.amount + 10, KNLG_SYMBOL ) );
...
BOOST_AUTO_TEST_CASE( knowledgr_inflation )
{
   ...
   {
   /*
      BOOST_TEST_MESSAGE( "Testing KNLG Inflation until the vesting start block" );
      ...
      auto new_rewards = std::max( KNOWLEDGR_MIN_CONTENT_REWARD, asset( ( KNOWLEDGR_CONTENT_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) )
         + std::max( KNOWLEDGR_MIN_CURATE_REWARD, asset( ( KNOWLEDGR_CURATE_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
      auto witness_pay = std::max( KNOWLEDGR_MIN_PRODUCER_REWARD, asset( ( KNOWLEDGR_PRODUCER_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
      auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
      auto new_vesting_knowledgr = asset( 0, KNLG_SYMBOL );
      ...
      while( db->head_block_num() < KNOWLEDGR_START_VESTING_BLOCK - 1)
      {
         ...
         new_rewards = std::max( KNOWLEDGR_MIN_CONTENT_REWARD, asset( ( KNOWLEDGR_CONTENT_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) )
            + std::max( KNOWLEDGR_MIN_CURATE_REWARD, asset( ( KNOWLEDGR_CURATE_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
         witness_pay = std::max( KNOWLEDGR_MIN_PRODUCER_REWARD, asset( ( KNOWLEDGR_PRODUCER_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
         new_vesting_knowledgr = asset( 0, KNLG_SYMBOL );
         ...
         if ( db->get_account( witness_name ).vesting_shares.amount.value == 0 )
         {
            ...
            witness_pay = asset( 0, KNLG_SYMBOL );
         }
      ...
      while( db->head_block_num() < KNOWLEDGR_START_MINER_VOTING_BLOCK - 1 )
      {
         ...
         witness_pay = std::max( KNOWLEDGR_MIN_PRODUCER_REWARD, asset( ( KNOWLEDGR_PRODUCER_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
         auto witness_pay_shares = asset( 0, VESTS_SYMBOL );
         new_vesting_knowledgr = asset( ( witness_pay + new_rewards ).amount * 9, KNLG_SYMBOL );
         new_vesting_shares = gpo.total_vesting_shares;
      ...
      for( int i = 0; i < KNOWLEDGR_BLOCKS_PER_DAY; i++ )
      {
         ...
         witness_pay = std::max( KNOWLEDGR_MIN_PRODUCER_REWARD, asset( ( KNOWLEDGR_PRODUCER_APR * gpo.virtual_supply.amount ) / ( KNOWLEDGR_BLOCKS_PER_YEAR * 100 ), KNLG_SYMBOL ) );
         witness_pay_shares = witness_pay * gpo.get_vesting_share_price();
         new_vesting_knowledgr = asset( ( witness_pay + new_rewards ).amount * 9, KNLG_SYMBOL ) + witness_pay;
      ...
      BOOST_REQUIRE_EQUAL( db->get_account( witness_name ).vesting_shares.amount.value,
         old_witness_shares.amount.value + ( asset( ( ( virtual_supply.amount.value / KNOWLEDGR_BLOCKS_PER_YEAR ) * KNOWLEDGR_1_PERCENT ) / KNOWLEDGR_100_PERCENT, KNLG_SYMBOL ) * ( vesting_shares / vesting_knowledgr ) ).amount.value );
      validate_database();
      */
   }
   FC_LOG_AND_RETHROW();
...
//       BOOST_TEST_MESSAGE( "Creating Limit Order for KNLG that will stay on the books for 30 minutes exactly." );
...
//       op.owner = "sam";
//       op.amount_to_sell = asset( ( alice_sbd.amount.value / 20 ), KNLG_SYMBOL );
...
//       op.owner = "bob";
//       op.orderid = 4;
//       op.amount_to_sell = asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, KNLG_SYMBOL );
...
//       op.min_to_receive = asset( ( alice_sbd.amount.value / 10 ) * 3, KNLG_SYMBOL );
...
//       BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( ( alice_sbd.amount.value / 10 ) * 3 - alice_sbd.amount.value / 20, KNLG_SYMBOL ).amount.value );
...
//       BOOST_REQUIRE( fill_order_op.open_pays.amount.value == asset( alice_sbd.amount.value / 20, KNLG_SYMBOL ).amount.value );
//       BOOST_REQUIRE( fill_order_op.current_owner == "alice" );
//       BOOST_REQUIRE( fill_order_op.current_orderid == 5 );
...
//       op.min_to_receive = asset( alice_sbd.amount.value / 20 * 2, KNLG_SYMBOL );
...
//       BOOST_REQUIRE( fill_order_op.current_pays.amount.value == asset( alice_sbd.amount.value / 20, KNLG_SYMBOL ).amount.value );
...
//       op.owner = "alice";
//       op.amount_to_sell = asset( 8 * ( alice_sbd.amount.value / 20 ), KNLG_SYMBOL );
...
//       op.min_to_receive = asset( op.amount_to_sell.amount, KNLG_SYMBOL );
//       op.orderid = 10;
//       tx.operations.clear();
//       tx.signatures.clear();
//       tx.operations.push_back( op );
...
//       op.min_to_receive.symbol = KNLG_SYMBOL;
//       tx.operations.clear();
//       tx.signatures.clear();
//       tx.operations.push_back( op );
//       tx.set_expiration( db->head_block_time() + KNOWLEDGR_MAX_TIME_UNTIL_EXPIRATION );
...
//
//      //asset sbd_balance = asset( ( gpo.virtual_supply.amount * ( gpo.sbd_stop_percent + 112 ) ) / KNOWLEDGR_100_PERCENT, KNLG_SYMBOL ) * exchange_rate;
...
//       BOOST_REQUIRE( db->get_dynamic_global_properties().sbd_print_rate < KNOWLEDGR_100_PERCENT );
// 
//       BOOST_TEST_MESSAGE( "Pay out comment and check rewards are paid as KNLG" );
//       db_plugin->debug_generate_blocks( debug_key, 1, database::skip_witness_signature );
// 
//       validate_database();
// 
...
//       auto new_exchange_rate = price( gpo.current_sbd_supply, asset( ( KNOWLEDGR_100_PERCENT ) * gpo.current_supply.amount, KNLG_SYMBOL ) );
