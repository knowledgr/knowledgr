...
operation_tests      // Unit Tests of Knowledgr operations
operation_time_tests // Tests of Knowledgr operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_KNOWLEDGR_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
