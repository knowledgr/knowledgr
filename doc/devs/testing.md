...
operation_tests      // Unit Tests of Colab operations
operation_time_tests // Tests of Colab operations that include a time based component (ex. vesting withdrawals)
...
```
cmake -D BUILD_COLAB_TESTNET=ON -D ENABLE_COVERAGE_TESTING=true -D CMAKE_BUILD_TYPE=Debug .
make
